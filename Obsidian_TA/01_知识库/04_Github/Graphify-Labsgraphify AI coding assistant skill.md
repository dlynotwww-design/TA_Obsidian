---
title: "Graphify-Labs/graphify: AI coding assistant skill (Claude Code, Codex, OpenCode, Cursor, Gemini CLI, and more). Turn any folder of code, SQL schemas, R scripts, shell scripts, docs, papers, images, or videos into a queryable knowledge graph. App code + database schema + infrastructure in one graph."
source: "https://github.com/Graphify-Labs/graphify"
author:
published:
created: 2026-07-15
description: "AI coding assistant skill (Claude Code, Codex, OpenCode, Cursor, Gemini CLI, and more). Turn any folder of code, SQL schemas, R scripts, shell scripts, docs, papers, images, or videos into a queryable knowledge graph. App code + database schema + infrastructure in one graph. - Graphify-Labs/graphify"
tags:
  - "clippings"
---
...
🇺🇸 [English](https://github.com/Graphify-Labs/graphify/blob/v8/README.md) | 🇨🇳 [简体中文](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.zh-CN.md) | 🇯🇵 [日本語](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.ja-JP.md) | 🇰🇷 [한국어](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.ko-KR.md) | 🇩🇪 [Deutsch](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.de-DE.md) | 🇫🇷 [Français](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.fr-FR.md) | 🇪🇸 [Español](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.es-ES.md) | 🇮🇳 [हिन्दी](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.hi-IN.md) | 🇧🇷 [Português](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.pt-BR.md) | 🇷🇺 [Русский](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.ru-RU.md) | 🇸🇦 [العربية](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.ar-SA.md) | 🇮🇷 [فارسی](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.fa-IR.md) | 🇮🇹 [Italiano](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.it-IT.md) | 🇵🇱 [Polski](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.pl-PL.md) | 🇳🇱 [Nederlands](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.nl-NL.md) | 🇹🇷 [Türkçe](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.tr-TR.md) | 🇺🇦 [Українська](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.uk-UA.md) | 🇻🇳 [Tiếng Việt](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.vi-VN.md) | 🇮🇩 [Bahasa Indonesia](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.id-ID.md) | 🇸🇪 [Svenska](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.sv-SE.md) | 🇬🇷 [Ελληνικά](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.el-GR.md) | 🇷🇴 [Română](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.ro-RO.md) | 🇨🇿 [Čeština](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.cs-CZ.md) | 🇫🇮 [Suomi](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.fi-FI.md) | 🇩🇰 [Dansk](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.da-DK.md) | 🇳🇴 [Norsk](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.no-NO.md) | 🇭🇺 [Magyar](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.hu-HU.md) | 🇹🇭 [ภาษาไทย](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.th-TH.md) | 🇺🇿 [Oʻzbekcha](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.uz-UZ.md) | 🇹🇼 [繁體中文](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.zh-TW.md) | 🇵🇭 [Filipino](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.fil-PH.md) | 🇮🇱 [עברית](https://github.com/Graphify-Labs/graphify/blob/v8/docs/translations/README.he-IL.md)
...
[![graphify's interactive graph.html showing the FastAPI codebase as a force-directed knowledge graph with a legend of detected communities](https://raw.githubusercontent.com/Graphify-Labs/graphify/v8/docs/graph-hero.png)](https://raw.githubusercontent.com/Graphify-Labs/graphify/v8/docs/graph-hero.png)
...
[![graphify path query: a terminal asks for the shortest path between FastAPI and ModelField, and the answer lights up hop by hop across the knowledge graph](https://raw.githubusercontent.com/Graphify-Labs/graphify/v8/docs/demo-path.svg)](https://raw.githubusercontent.com/Graphify-Labs/graphify/v8/docs/demo-path.svg)
...
Every system ran on the same harness with the same model and budgets, scored by a judge blind-validated against a second judge (90.6% agreement, Cohen's kappa 0.81). Full per-system tables, the code-intelligence result, and reproduction commands: **[BENCHMARKS.md](https://github.com/Graphify-Labs/graphify/blob/v8/BENCHMARKS.md)**.
...
- [How it works](https://github.com/Graphify-Labs/graphify/blob/v8/docs/how-it-works.md) — the extraction pipeline, community detection, confidence scoring, benchmarks
- [ARCHITECTURE.md](https://github.com/Graphify-Labs/graphify/blob/v8/ARCHITECTURE.md) — module breakdown, how to add a language
- [Optional integrations](https://github.com/Graphify-Labs/graphify/blob/v8/docs/docker-mcp-sqlite.md) — Docker MCP Toolkit + SQLite
...
See [ARCHITECTURE.md](https://github.com/Graphify-Labs/graphify/blob/v8/ARCHITECTURE.md) for module responsibilities and how to add a language.