---
title: "arafays/messenger-copy: Unofficial AI-assisted learning rebuild of messenger.abeto.co (SvelteKit + Three.js)"
source: "https://github.com/arafays/messenger-copy"
author:
published:
created: 2026-06-26
description: "Unofficial AI-assisted learning rebuild of messenger.abeto.co (SvelteKit + Three.js) - arafays/messenger-copy"
tags:
  - "clippings"
---
## messenger-copy
...
> **Disclaimer:** This is not the real game. It is a local, AI-assisted rebuild for study only. All original art, audio, and design remain the property of their respective owners. See [ATTRIBUTION.md](https://github.com/arafays/messenger-copy/blob/main/ATTRIBUTION.md).
...
- **Repository code** (`src/`, scripts, config): [MIT](https://github.com/arafays/messenger-copy/blob/main/LICENSE)
