...
published:
created: 2026-07-05
description: "从零构建 Claude Code：~4300 行代码的分步教程"
tags:
  - "clippings"
---
...
[**📘 在线阅读教程 →**](https://windy3f3f3f3f.github.io/claude-code-from-scratch/) | [📘 Read Tutorial (English) →](https://windy3f3f3f3f.github.io/claude-code-from-scratch/#/en/) | [English](#/./README_EN)
...
**Python 版** （需要 Python 3.11+， [详细说明](#/./python/README) ）
...
| 工具数量 | 66+ 内置工具 | 13 个工具（6 核心 + web\_fetch + tool\_search + skill + agent + plan mode） |
...
- **并行工具执行** ：只读工具（read\_file、grep\_search 等）自动并发，2-3x 加速
...
| ![](https://github.com/Windy3f3f3f3f.png) | ![](https://github.com/davidweidawang.png) | ![](https://diwang.info/claude-code-from-scratch/assets/kaibo.jpg) |
| --- | --- | --- |
...
![QQ 群二维码](https://diwang.info/claude-code-from-scratch/assets/qq.jpg)
